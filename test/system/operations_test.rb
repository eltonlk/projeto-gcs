...
class OperationsTest < ApplicationSystemTestCase
  ...
  test "creating a Operation" do
    ...
    fill_in "Bank account", with: @operation.bank_account_id
    fill_in "Comment", with: @operation.comment
    fill_in "Description", with: @operation.description
    fill_in "Due at", with: @operation.due_at
    check "Flow in" if @operation.flow_in
    check "Paid" if @operation.paid
